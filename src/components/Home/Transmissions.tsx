        ...
        {episodes.map((ep) => {
          ...
          return (
            ...
            >
              ...
              <div className="ec-type-bar" style={{ background: typeStyle.bg, color: typeStyle.text }}>
                {ep.type.toUpperCase()}
                {ep.active && <span style={{ fontSize: '.4rem', opacity: .7 }}>● LIVE</span>}
                <div className="hz"><div className="hz-s"></div><div className="hz-s"></div><div className="hz-s"></div></div>
              </div>
